...
from .dataloader_sc import SC
from .dataloader_sc_128 import Sichuan128
from .dataloader_hko7 import HKO7
...
__all__ = [
    ...
    'WeatherBenchDataset', 'SEVIRDataset', 'SC',
    'load_data', 'dataset_parameters', 'create_loader', 'BaseDataModule', 'HKO7', 'Sichuan128'
]